...
enum AuthResult : int {
  ...
  AUTH_RESULT_PASSWORD_MISMATCH = 2,
  AUTH_RESULT_EMPTY_CREDENTIALS = 3,
  AUTH_RESULT_USERNAME_EXISTS = 4,
  AUTH_RESULT_INVALID_CREDENTIALS = 5,
  AUTH_RESULT_INTERNAL_ERROR = 6,
...
constexpr AuthResult AuthResult_MAX = AUTH_RESULT_INTERNAL_ERROR;
...
class RegisterResponse final :
 ...
 public:
  ...
  void set_result(::AuthResult value);
  private:
  ::AuthResult _internal_result() const;
  void _internal_set_result(::AuthResult value);
  public:
...
inline ::AuthResult RegisterResponse::_internal_result() const {
  return static_cast< ::AuthResult >(result_);
}
inline ::AuthResult RegisterResponse::result() const {
  // @@protoc_insertion_point(field_get:RegisterResponse.result)
  return _internal_result();
}
inline void RegisterResponse::_internal_set_result(::AuthResult value) {
  
  result_ = value;
}
inline void RegisterResponse::set_result(::AuthResult value) {
...
inline ::AuthResult LoginResponse::_internal_result() const {
  return static_cast< ::AuthResult >(result_);
}
inline ::AuthResult LoginResponse::result() const {
  // @@protoc_insertion_point(field_get:LoginResponse.result)
  return _internal_result();
}
inline void LoginResponse::_internal_set_result(::AuthResult value) {
  
  result_ = value;
}
inline void LoginResponse::set_result(::AuthResult value) {
  _internal_set_result(value);
...
template <> struct is_proto_enum< ::AuthResult> : ::std::true_type {};
template <>
