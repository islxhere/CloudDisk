...
const char descriptor_table_protodef_auth_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\022\020\n\010username\030\003 \001(\t\022\033\n\006result\030\004 \001(\0162\013.Aut"
  "hResult\"2\n\014LoginRequest\022\020\n\010username\030\001 \001("
  "\t\022\020\n\010password\030\002 \001(\t\"v\n\rLoginResponse\022\023\n\013"
  "accessToken\030\001 \001(\t\022\021\n\ttokenType\030\002 \001(\t\022\016\n\006"
  "userId\030\003 \001(\004\022\020\n\010username\030\004 \001(\t\022\033\n\006result"
  "\030\005 \001(\0162\013.AuthResult*\356\001\n\nAuthResult\022\033\n\027AU"
  "TH_RESULT_UNSPECIFIED\020\000\022\027\n\023AUTH_RESULT_S"
  "UCCESS\020\001\022!\n\035AUTH_RESULT_PASSWORD_MISMATC"
  "H\020\002\022!\n\035AUTH_RESULT_EMPTY_CREDENTIALS\020\003\022\037"
  "\n\033AUTH_RESULT_USERNAME_EXISTS\020\004\022#\n\037AUTH_"
  "RESULT_INVALID_CREDENTIALS\020\005\022\036\n\032AUTH_RES"
  "ULT_INTERNAL_ERROR\020\0062_\n\004Auth\022/\n\010Register"
  "\022\020.RegisterRequest\032\021.RegisterResponse\022&\n"
  "\005Login\022\r.LoginRequest\032\016.LoginResponseb\006p"
  "roto3"
  ;
static ::_pbi::once_flag descriptor_table_auth_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_auth_2eproto = {
    false, false, 685, descriptor_table_protodef_auth_2eproto,
    "auth.proto",
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          CHK_(ptr);
          _internal_set_result(static_cast<::AuthResult>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* LoginResponse::_InternalSerialize(
  ...
  if (!this->_internal_tokentype().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_tokentype(), target);
  }

  // uint64 userId = 3;
  if (this->_internal_userid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(3, this->_internal_userid(), target);
  }
